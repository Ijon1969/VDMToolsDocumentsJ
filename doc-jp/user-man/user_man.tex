...
#ifdef VICEMAN   %%%%%%%%%%%%%%%%%%%%%%%%%%% new command for VDM++ VICE
\renewcommand{\vdmslpp}{VDM++ VICE}
\renewcommand{\vdmslppEm}{VDM++ VICE}
\renewcommand{\ToolboxName}{VDM++ VICE Toolbox}
\renewcommand{\vdmde}{vicede}
\renewcommand{\vdmgde}{vicegde}
\renewcommand{\vdmhome}{vpphome}
\renewcommand{\vdmdeNineteenEl}{vicede.el}
\DeclareRobustCommand{\VdmSlPp}{VDM++ VICE-\VdmSl}
#endif VICEMAN %%%%%%%%%%%%%%%%%%%%%%%%%% new vcommand for VDM++ VICE
...
#endif VDMSL
#ifdef VDMPP
You will see that the name of the class {\tt MergeSort} is written in the style \texttt{VDM\_TC\_TABLE}.
#endif VDMPP
...
#endif PPONLY
#ifdef VICEMAN
C: \yen Program Files \yen The VDM++ VICE Toolbox v?.?
#endif VICEMAN
...
\raisebox{-0.8mm}{\includegraphics[width=0.03\textwidth]{java2vdm.png}}):] see~\cite{Java2VDMMan-SCSK}
#endif VDMPP
...
#endif VDMSL
#ifdef VDMPP
%\includegraphics[width=\textwidth]{sourceWindow-ppENG.png}
\includegraphics[width=9cm]{sourceWindow-pp.png}
#endif VDMPP
#ifdef VDMSL
\includegraphics[width=9cm]{sourceWindow-sl.png}
...
#ifdef VDMPP
\item[*create (cr)] {\tt name := expr}\index{create command}\mbox{}\\
...
%  should be 127.0.0.1. See \cite{InstallPPMan-SCSK} for details.\\
#endif //VDMPP
#endif ENG
...
the external UML tool. At the moment there is support to astah* pro:
\begin{quote}
...
\begin{center}
#ifdef ENG
\includegraphics[width=11cmh]{toolOptions-umlENG.png}
\caption{UML Link Options}
#endif ENG
#ifdef JPN
